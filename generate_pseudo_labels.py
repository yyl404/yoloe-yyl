...
from tools.incremental_utils import process_pseudo_labels
...
if __name__ == "__main__":
    ...
    teacher_model = YOLO(args.teacher_model_path)
    process_pseudo_labels(teacher_model, yaml_load(args.data), args.data, args.save_dir, args.task_id,
